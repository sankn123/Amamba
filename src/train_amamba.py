...
match dataset:
    case "FSC22":
        ...
        learning_rate=1e-5
        batch_size=32
        classes = ("Fire", "Rain", "Thunderstorm", "WaterDrops", "Wind", "Silence", "TreeFalling", "Helicopter", "VehicleEngine", 
                   "Axe", "Chainsaw", "Generator", "Handsaw", "Firework", "Gunshot", "WoodChop", "Whistling", "Speaking", 
                   "Footsteps", "Clapping", "Insect", "Frog", "BirdChirping", "WingFlaping", "Lion", "WolfHowl", "Squirrel")
...
if plot_cm:
    ...
    plt.savefig(f'/mnt/r/sankn-2/Amamba/log_files/{dataset}/{dataset}_loss_curve.pdf')
    ...
    plt.savefig(f'/mnt/r/sankn-2/Amamba/log_files/{dataset}/{dataset}_acc_curve.pdf')
    ...
    plt.savefig(f'/mnt/r/sankn-2/Amamba/log_files/{dataset}/{dataset}_cm.pdf')
